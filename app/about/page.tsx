...
export const metadata: Metadata = {
	...
	description: 'Learn about RoboResume — the AI-powered resume builder built to help you land your next job faster.'
}
		...
		<div className="min-h-screen flex flex-col bg-cream">
			...
			<main className="flex-1">
				...
				<section className="max-w-2xl mx-auto px-6 pb-16">
					<div className="bg-white border border-yellow/60 rounded-2xl p-8 space-y-4">
						...
						<p className="text-dark/70 leading-relaxed">
							We built RoboResume because writing a resume is one of the most frustrating parts of job
							searching. You spend hours formatting, rewriting, and second-guessing every word — and
							it still might not pass an ATS filter.
						</p>
						<p className="text-dark/70 leading-relaxed">
							Our goal is simple: give everyone access to a great resume, regardless of their writing
							skills or design experience. With AI assistance, live previews, and one-click export,
							you can go from blank page to job application in under 10 minutes.
						</p>
					</div>
				</section>
				...
				<section className="bg-beige border-t border-yellow py-16 text-center px-6">
					...
					<p className="text-dark/70 mb-8">It&apos;s free to get started — no credit card required.</p>
					<Link
