...
import { Zap, Shield, CreditCard, HelpCircle, Sparkles } from 'lucide-react'
				...
				<section className="px-4 pb-12 pt-16 text-center sm:pb-16 sm:pt-24">
					<div className="mx-auto max-w-3xl">
						...
						<p className="mt-6 text-lg leading-relaxed text-dark/70 sm:text-xl">
							Build a world-class resume for free. Upgrade to Pro when you need
							unlimited AI power to land your dream job faster.
						</p>
					</div>
				</section>
				...
				<section className="bg-beige px-4 py-16 sm:py-20">
					<div className="mx-auto max-w-2xl">
						<div className="mb-10 text-center">
							...
							<h2 className="mt-2 text-3xl font-bold tracking-tighter text-dark">
								Got questions?
							</h2>
						...
						<div className="flex flex-col gap-4">
							<div className="rounded-xl border border-yellow bg-cream p-6">
								...
								<p className="mt-2 text-sm leading-relaxed text-dark/70">
									Yes, absolutely. You can cancel at any time from your account
									settings. Your Pro benefits stay active until the end of your
									current billing period, after which your account reverts to the
									Free plan — no fees, no hassle.
								</p>
							</div>
							...
							<div className="rounded-xl border border-yellow bg-cream p-6">
								...
								<p className="mt-2 text-sm leading-relaxed text-dark/70">
									Completely. We use{' '}
									<span className="font-medium text-dark">Stripe</span> — a
									PCI-DSS Level 1 certified payment processor — to handle all
									transactions. Robo Resume never stores your card details on our
									servers.
								</p>
							</div>
							...
							<div className="rounded-xl border border-yellow bg-cream p-6">
								...
								<p className="mt-2 text-sm leading-relaxed text-dark/70">
									We offer a{' '}
									<span className="font-medium text-dark">14-day money-back guarantee</span>{' '}
									on all Pro subscriptions. If you&apos;re not satisfied, contact
									us within 14 days of your purchase and we&apos;ll issue a full
									refund — no questions asked. EU consumers also have statutory
