...
import { CreditCard, Zap, CheckCircle2, XCircle, Calendar, TrendingUp, Crown, ArrowUpCircle } from 'lucide-react'
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            >
                                ...
                                <p className="text-2xl font-bold text-dark">
                                    $9<span className="text-sm font-normal text-dark/50"> / month</span>
                                </p>
                                <Separator className="bg-yellow/50" />
                                <ul className="space-y-2">
