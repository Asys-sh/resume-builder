		...
		<div className="min-h-screen flex flex-col bg-cream">
			...
			<main className="flex-1 max-w-2xl mx-auto px-6 py-16 w-full">
				...
				<p className="text-dark/70 mb-10 text-lg">
					We want you to be happy with RoboResume. If you&apos;re not satisfied, we&apos;re here to help.
				</p>
				...
				<div className="bg-yellow/20 border border-yellow rounded-xl p-6 mb-8 flex gap-4">
					...
					<div>
						...
						<p className="text-sm text-dark/70">
							If you are an EU consumer, you have the right to withdraw from your subscription contract within{' '}
							<strong>14 days</strong> of the date of purchase without giving any reason. To exercise this right,
							contact us at the email below before the 14-day period expires.
						</p>
					</div>
				</div>
				...
				<div className="bg-white border border-yellow/60 rounded-xl p-6 mb-8 space-y-5">
					...
					<div className="flex gap-4">
						...
						<div>
							...
							<p className="text-sm text-dark/70 mt-0.5">
								Please include the email address associated with your account and the approximate date of purchase.
							</p>
						</div>
					</div>
					...
					<div className="flex gap-4">
						...
						<div>
							...
							<p className="text-sm text-dark/70 mt-0.5">
								We&apos;ll review your request and respond within 3 business days. Approved refunds are returned to
