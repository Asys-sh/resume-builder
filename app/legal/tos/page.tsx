export default function TOS() {
  return (
    <div className="bg-yellow flex flex-col gap-4 p-8">
      ...
      <p>
        By using the Service, you agree to these Terms. If you do not agree, you may not use the
        Service.
      </p>
      ...
      <p>
        To access certain features (including AI and premium templates), you must create an account.
        You agree to provide accurate information, protect your login credentials, and are
        responsible for all activity under your account.
      </p>

      <h2>4. User Content</h2>
      <p>
        “<strong>User Content</strong>” includes any resume text, documents, personal data, or
        materials you upload or create using the Service.
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>You may cancel anytime in your account settings.</li>
        <li>
          Fees already paid are <strong>non-refundable</strong> except where required by law.
        </li>
      </ul>

      <h3>6.1 Refund Policy – EU Right of Withdrawal</h3>
      <p>
        Under EU consumer protection law, you have the right to withdraw from your subscription
        within <strong>14 days</strong> of purchase.
      </p>
      ...
      <ul>
        <li>request the immediate performance of the digital service, and</li>
        <li>
          acknowledge that you <strong>lose your right to withdraw</strong> once the service has
          been fully provided or significantly used.
        </li>
      </ul>
      ...
      <ul>
        <li>Reverse engineer or redistribute platform code, templates, or designs</li>
        <li>Upload illegal or harmful content</li>
        <li>Use the Service for fraud or spam</li>
        <li>Interfere with the Service’s security</li>
        <li>Bypass payment or access restrictions</li>
      </ul>
      ...
      <p>
        ...
        warranties of any kind. We do not guarantee the accuracy of AI suggestions or that the
      ...
      <p>
        These Terms are governed by the laws of <strong>France</strong> and applicable{' '}
        <strong>EU regulations</strong>. Disputes will be handled in French courts.
      </p>

      <h2>13. Changes to These Terms</h2>
      <p>
        We may update these Terms periodically. Continued use of the Service indicates acceptance of
        the updated Terms.
      </p>
