export default function TOS() {
	return (
		<div className="bg-yellow flex flex-col gap-4 p-8">
			...
			<p>
				To access certain features (including AI and premium templates), you must create an account. You agree to
				provide accurate information, protect your login credentials, and are responsible for all activity under your
				account.
			</p>

			<h2>4. User Content</h2>
			<p>
				“<strong>User Content</strong>” includes any resume text, documents, personal data, or materials you upload or
			...
			<p>
				Under EU consumer protection law, you have the right to withdraw from your subscription within{' '}
			...
			<ul>
				...
				<li>
					acknowledge that you <strong>lose your right to withdraw</strong> once the service has been fully provided or
					significantly used.
				</li>
			</ul>
			...
			<p>
				The Service is provided <strong>“as-is”</strong> and <strong>“as-available”</strong> without warranties of any
				kind. We do not guarantee the accuracy of AI suggestions or that the Service will be uninterrupted.
			</p>
			...
			<p>
				These Terms are governed by the laws of <strong>France</strong> and applicable <strong>EU regulations</strong>.
				Disputes will be handled in French courts.
			</p>
